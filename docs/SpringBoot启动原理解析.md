...
![EnableAutoConfiguration得以生效的关键组件关系图](imgs/springboot3-1.png)
...
![spring.factories文件内容](imgs/springboot3-2.jpg)
...
![SpringApplication执行流程](imgs/springboot3-3.jpg)
...
参考
本章节大部分参考了《SpringBoot揭秘快速构建为服务体系》这本书的第三章，个人看过的几本书就感觉这本书介绍原理的章节最为透彻，本章也算这本书最精华的部分。所以我没忍住就分享出来给大家。当然主要是我也没有这本书的电子版，无法分享给大家了，深表遗憾(。・＿・。)ﾉ学习